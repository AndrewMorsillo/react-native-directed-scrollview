...
public class DirectedScrollViewChildManager
    extends ViewGroupManager<DirectedScrollViewChild> {
  @Override
  ...
  @Override
  public DirectedScrollViewChild createViewInstance(
  ...
  public void setScrollDirection(
      DirectedScrollViewChild view,
      @Nullable String scrollDirection) {
