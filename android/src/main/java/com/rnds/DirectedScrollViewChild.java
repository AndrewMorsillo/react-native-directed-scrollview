...
public class DirectedScrollViewChild extends ReactViewGroup {
  ...
  public boolean getShouldScrollHorizontally() {
    return Objects.equal(this.scrollDirection, SCROLL_DIRECTION_BOTH) ||
        Objects.equal(this.scrollDirection, SCROLL_DIRECTION_HORIZONTAL);
  }

  public boolean getShouldScrollVertically() {
    return Objects.equal(this.scrollDirection, SCROLL_DIRECTION_BOTH) ||
        Objects.equal(this.scrollDirection, SCROLL_DIRECTION_VERTICAL);
  }
